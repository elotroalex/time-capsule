...
<figure>
  <img src="/time-capsule/assets/figures/2012B.jpg" alt="Fig2" style="width:100%">
  <figcaption>Figure 2: Uprooted concrete capsule</figcaption>
</figure> 
...
<figure>
  <img src="/time-capsule/assets/figures/2012C.jpg" alt="Fig3" style="width:100%">
  <figcaption>Figure 3: Ronald G. Beckett drilling into the concrete base hoping to hit the “hollow core” suggested by the New Haven Bomb Squad image. After drilling approximately halfway into the structure, Ronald G. Beckett took a look with his endoscope.</figcaption>
</figure>
...
<figure>
  <img src="/time-capsule/assets/figures/2012D.jpg" alt="Fig4" style="width:100%">
  <figcaption>Figure 4: The first attempt to cut into the concrete was made with a saw (A) and then a hammer (B)</figcaption>
</figure> 

<figure>
  <img src="/time-capsule/assets/figures/2012E.jpg" alt="Fig5" style="width:100%">
  <figcaption>Figure 5: Within the skillful hands of an expert in the use of a jackhammer, the corner of a copper cylinder became visible. A short time later the entire capsule was exposed.</figcaption>
</figure> 
...
<figure>
  <img src="/time-capsule/assets/figures/2012F.jpg" alt="Fig5" style="width:45%">
  <img src="/time-capsule/assets/figures/2012G.jpg" alt="Fig5" style="width:45%">
  <figcaption>Figure 6: Scans of the interior of the capsule. The first image reveal a hole through the contained created by Ron’s drilling (yellow arrow). A number of other features regarding construction of the container were also demonstrated including the “cap” (B), “crimping” to seal the bottom (orange arrow), and a seam along the side (D). Within the capsule there appeared to be a circular object later identified as a Grape Shot (green arrow). The second scan also reveals a star-shaped object with an eagle and some layered materials (newspapers)</figcaption>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/PdFkKBc9ROY" title="YouTube video player" frameborder="15" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
