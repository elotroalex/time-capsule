...
<code>{% raw %}
  {% include collection_gallery.html collection='uprooted'
...
<code>{% raw %}{% include collection_gallery.html collection='uprooted' facet_by='object_type' only='portrait' num_column=4 %}{% endraw %}</code>
